...
CURSOS_DISPONIVEIS = [
    ...
    {"id": "03", "nome": "AUXILIAR DE CRECHE COM \u00caNFASE EM INCLUS\u00c3O"},
    {"id": "04", "nome": "CROCH\u00ca"},
    {"id": "05", "nome": "PEDICURE"},
    {"id": "06", "nome": "BARBEIRO"},
...
COURSE_OPTIONS = [
    # ── Turmas originais ─────────────────────────────────────────────────────
    {"id":"1","curso_id":"01","curso":"MARCENARIA","turma":"MARCENARIA - TURMA 01","local":"POLO CAPIBERIBE \u2014 T\u00c9RREO","dias_aula":"Quartas-feiras","horario":"18h \u00e0s 21h","vagas":"30","data_inicio":"26/08/2026","encerramento":"23/09/2026","endereco_curso":"\U0001f4cdRua Capiberibe 32"},
    {"id":"8","curso_id":"02","curso":"NO\u00c7\u00d5ES B\u00c1SICAS DE INSTALA\u00c7\u00c3O EL\u00c9TRICA RESIDENCIAL","turma":"NO\u00c7\u00d5ES B\u00c1SICAS DE INSTALA\u00c7\u00c3O EL\u00c9TRICA RESIDENCIAL - TURMA 01","local":"POLO CAMPO GRANDE \u2014 T\u00c9RREO","dias_aula":"S\u00e1bados","horario":"09h \u00e0s 16h","vagas":"50","data_inicio":"12/09/2026","encerramento":"26/09/2026","endereco_curso":"\U0001f4cdRua Girasol, n\u00ba 47 \u2014 Polo Campo Grande"},
    {"id":"3","curso_id":"03","curso":"AUXILIAR DE CRECHE COM \u00caNFASE EM INCLUS\u00c3O","turma":"AUXILIAR DE CRECHE COM \u00caNFASE EM INCLUS\u00c3O - TURMA 01","local":"POLO SANTA CRUZ \u2014 T\u00c9RREO","dias_aula":"Ter\u00e7a e Quinta","horario":"18h30 \u00e0s 21h30","vagas":"50","data_inicio":"25/08/2026","encerramento":"08/09/2026","endereco_curso":"\U0001f4cdAvenida Jo\u00e3o XXIII, n\u00famero 53, rua 01, quadra D"},
    {"id":"4","curso_id":"04","curso":"CROCH\u00ca","turma":"CROCH\u00ca - TURMA 01","local":"POLO NOVA IGUA\u00c7U \u2014 T\u00c9RREO","dias_aula":"Ter\u00e7a e Quinta","horario":"13h \u00e0s 16h","vagas":"50","data_inicio":"01/09/2026","encerramento":"15/09/2026","endereco_curso":"\U0001f4cdTravessa Delfim Moreira n\u00ba 14"},
    {"id":"5","curso_id":"05","curso":"PEDICURE","turma":"PEDICURE - TURMA 01","local":"POLO NOVA IGUA\u00c7U \u2014 T\u00c9RREO","dias_aula":"Segunda, Ter\u00e7a e Quarta","horario":"09h \u00e0s 16h","vagas":"50","data_inicio":"31/08/2026","encerramento":"02/09/2026","endereco_curso":"\U0001f4cdTravessa Delfim Maur\u00edcio, 17"},
    {"id":"6","curso_id":"06","curso":"BARBEIRO","turma":"BARBEIRO - TURMA 01","local":"ASSOCIA\u00c7\u00c3O DE MORADORES DO VIDIGAL","dias_aula":"Ter\u00e7a, Quarta e Quinta","horario":"9h \u00e0s 16h","vagas":"50","data_inicio":"01/09/2026","encerramento":"03/09/2026","endereco_curso":"\U0001f4cdPresidente Jo\u00e3o Goulart, 737 (em frente \u00e0 Igreja Universal)"},
    {"id":"7","curso_id":"07","curso":"CORTE E COSTURA","turma":"CORTE E COSTURA - TURMA 01","local":"CENTRAL DO TRABALHADOR DE JACAREPAGU\u00c1 \u2014 268","dias_aula":"Segunda, Ter\u00e7a, Quarta, Quinta e Sexta","horario":"13h \u00e0s 16h","vagas":"50","data_inicio":"31/08/2026","encerramento":"04/09/2026","endereco_curso":"\U0001f4cdAvenida Gemer\u00e1rio Dantas 1400 sala 268"},
    {"id":"10","curso_id":"03","curso":"AUXILIAR DE CRECHE COM \u00caNFASE EM INCLUS\u00c3O","turma":"AUXILIAR DE CRECHE COM \u00caNFASE EM INCLUS\u00c3O - TURMA 02","local":"POLO CAMPO GRANDE \u2014 SOBRADO","dias_aula":"Ter\u00e7a e Quinta","horario":"18:30 \u00e0s 21:30h","vagas":"50","data_inicio":"01/09/2026","encerramento":"15/09/2026","endereco_curso":"\U0001f4cdRua Claudio Cecil Poland, n\u00ba 30, casa 02 - Conjunto Campinho"},
    {"id":"11","curso_id":"08","curso":"NO\u00c7\u00d5ES B\u00c1SICAS DE INSTALA\u00c7\u00c3O EL\u00c9TRICA 2","turma":"NO\u00c7\u00d5ES B\u00c1SICAS DE INSTALA\u00c7\u00c3O EL\u00c9TRICA 2 - TURMA 01","local":"CENTRAL DO TRABALHADOR DE JACAREPAGU\u00c1 \u2014 SALA 268","dias_aula":"S\u00e1bados","horario":"9:00 \u00e0s 14:00h","vagas":"50","data_inicio":"12/09/2026","encerramento":"26/09/2026","endereco_curso":"\U0001f4cdAvenida Gemer\u00e1rio Dantas, 1400, Sala 268"},
    # ── Novas turmas ─────────────────────────────────────────────────────────
    {"id":"12","curso_id":"09","curso":"MEDIADOR ESCOLAR COM \u00caNFASE EM INCLUS\u00c3O","turma":"MEDIADOR ESCOLAR COM \u00caNFASE EM INCLUS\u00c3O - TURMA 01","local":"POLO COSMOS II \u2014 T\u00c9RREO","dias_aula":"Quartas-feiras","horario":"16h \u00e0s 19h","vagas":"40","data_inicio":"26/08/2026","encerramento":"23/09/2026","endereco_curso":"\U0001f4cdRua Seis, 210. Igreja Metodista"},
    {"id":"13","curso_id":"10","curso":"RECEPCIONISTA DE EXCEL\u00caNCIA","turma":"RECEPCIONISTA DE EXCEL\u00caNCIA - TURMA 01","local":"POLO COSMOS II \u2014 T\u00c9RREO","dias_aula":"Quartas-feiras","horario":"16h \u00e0s 19h","vagas":"40","data_inicio":"26/08/2026","encerramento":"23/09/2026","endereco_curso":"\U0001f4cdRua Seis, 210. Igreja Metodista"},
    {"id":"14","curso_id":"11","curso":"AUXILIAR DE CRECHE COM \u00caNFASE EM INCLUS\u00c3O (VIDIGAL)","turma":"AUXILIAR DE CRECHE COM \u00caNFASE EM INCLUS\u00c3O - TURMA 01","local":"ASSOCIA\u00c7\u00c3O DE MORADORES DO VIDIGAL \u2014 ASSOCIA\u00c7\u00c3O DE MORADORES","dias_aula":"Ter\u00e7a e Quinta","horario":"16h30 \u00e0s 19h30","vagas":"40","data_inicio":"25/08/2026","encerramento":"08/09/2026","endereco_curso":"\U0001f4cdAvenida Presidente Jo\u00e3o Goulart, 737"},
    {"id":"15","curso_id":"12","curso":"LIBRAS","turma":"LIBRAS - TURMA 01","local":"POLO CAMPO GRANDE II \u2014 SOBRADO","dias_aula":"Quartas-feiras","horario":"17h30 \u00e0s 20h30","vagas":"30","data_inicio":"26/08/2026","encerramento":"23/09/2026","endereco_curso":"\U0001f4cdRua Luiz Carlos Palmeiras, 29. Parque Pedro, Campo Grande"},
]
...
<head>
    ...
    <style>
        :root { --cor-principal:#0e7752; --cor-principal-escura:#09563b; --cor-clara:#eef9f4; --cor-texto:#21473a; --cor-borda:#9fd6bf; --sombra-card:0 18px 55px rgba(14,119,82,0.18); }
        * { box-sizing: border-box; } html, body { min-height: 100%; margin: 0; padding: 0; }
        body { min-height:100vh; background:radial-gradient(circle at top left,rgba(14,119,82,0.14),transparent 34%),radial-gradient(circle at top right,rgba(198,232,216,0.82),transparent 32%),linear-gradient(135deg,#f5fcf8 0%,#fff 42%,#def5ea 100%); color:var(--cor-texto); font-family:'Wise',Arial,sans-serif; }
            ...
            <form id="wizard-form" method="POST" action="{{ url_for('inscricao_unica') }}" autocomplete="off" novalidate>
                <section class="wizard-panel" data-step="index">
                    <div class="hero-grid"><div class="hero-card">
                        ...
                        <p class="hero-subtitle">Conectando vidas, transformando pessoas.</p>
                ...
                <section class="wizard-panel" data-step="escolher">
                    <div class="step-card">
                        ...
                        <div class="step-grid step-grid--stacked">
                            <div class="form-group full"><label for="curso_select">Selecione o curso *</label><select id="curso_select" name="curso_select"><option value="">Selecione um curso</option>{% for curso in cursos_disponiveis %}<option value="{{ curso.id }}" {% if curso_selecionado == curso.id %}selected{% endif %}>{{ curso.nome }}</option>{% endfor %}</select></div>
                            <div class="form-group full"><label for="turma_select">Selecione a turma *</label><select id="turma_select" name="opcao_id"><option value="">Primeiro selecione um curso</option></select><div class="balao-erro" id="opcao_id-error" {% if not errors.get('opcao_id') %}hidden{% endif %}>{{ errors.get('opcao_id', '') }}</div></div>
                            <div class="form-group full"><label for="curso">Curso</label><input type="text" id="curso" name="curso" class="readonly-field" readonly value="{{ form_data.get('curso', '') }}"></div>
                            <div class="form-group full"><label for="local">Local</label><input type="text" id="local" name="local" class="readonly-field" readonly value="{{ form_data.get('local', '') }}"></div>
                            <div class="form-group full"><label for="turma">Turma</label><input type="text" id="turma" name="turma" class="readonly-field" readonly value="{{ form_data.get('turma', '') }}"></div>
                            <div class="form-group full"><label for="dias_aula">Dias de aula</label><input type="text" id="dias_aula" name="dias_aula" class="readonly-field" readonly value="{{ form_data.get('dias_aula', '') }}"></div>
                            <div class="form-group full"><label for="horario">Hor&#225;rio</label><input type="text" id="horario" name="horario" class="readonly-field" readonly value="{{ form_data.get('horario', '') }}"></div>
                            <div class="form-group full"><label for="data_inicio">Data de in&#237;cio</label><input type="text" id="data_inicio" name="data_inicio" class="readonly-field" readonly value="{{ form_data.get('data_inicio', '') }}"></div>
                            <div class="form-group full"><label for="encerramento">Encerramento</label><input type="text" id="encerramento" name="encerramento" class="readonly-field" readonly value="{{ form_data.get('encerramento', '') }}"></div>
                    ...
                    <div class="step-card">
                        ...
                        <div class="review-layout">
                            ...
                            <div class="review-box full">
                                <div style="margin-bottom:10px;color:#2f6a55;font-size:0.98rem;text-align:left;"><strong>Elegibilidade:</strong> Este projeto &#233; destinado a pessoas com 18 anos ou mais.</div>
...
<head>
    ...
    <style>
        ...
        @media(max-width:640px){
            html,body{width:100%!important;max-width:100%!important;overflow-x:hidden!important;}.main-header{padding:10px 12px;}.header-logos{display:flex;flex-direction:column;align-items:center;gap:10px;}.header-logos img,.logo,.logo-prefeitura-topo{max-width:min(88vw,280px);height:auto;}
